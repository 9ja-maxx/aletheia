...
// ---- Types reflecting Aletheia contract state structures ------------------
...
export function proposeThesis(client: WalletClient, topic: string, openingClaim: string, evidenceUrl: string) {
  return client.writeContract({
    address: CONTRACT_ADDRESS,
    functionName: 'propose_thesis',
    args: [topic, openingClaim, evidenceUrl],
    value: 0n,
  });
}
